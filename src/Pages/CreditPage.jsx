        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between border-b border-gray-100 bg-gray-50/50 px-8 py-5">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">{isEdit ? "Edit Transactions Entry" : "Add New Account Transactions"}</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                            <div>
                                ...
                                <select
                                    name="trancation_type"
                                    value={formData.trancation_type}
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className={`${inputStyle} font-semibold ${formData.status === "Success"
                                            ? "text-green-600"
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
            <div className="w-full max-w-sm rounded-lg bg-white p-6 shadow-lg" onClick={(e) => e.stopPropagation()}>
                <h2 className="mb-2 text-lg font-semibold text-gray-800">Delete Transactions</h2>
                <p className="text-sm text-gray-600">Are you sure you want to delete this Account Transactions record?</p>
...
function CreditPage() {
    ...
    const openEditModal = (row) => {
        setEditingRow(row);
        setFormData({
            trancation_type: row?.trancation_type || "",
        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="mx-auto max-w-7xl">
                <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight text-slate-900">Account Transactions </h1>
                    ...
                    >
                        <Plus size={18} /> Add New Account Transactions
                    </button>
                </div>
                        ...
                        <table className="w-full border-collapse text-left">
                            <thead>
                                <tr className="bg-slate-50/50">
                                    ...
                                    <th className="border-b border-slate-100 px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-600">
                                        Type
                                    </th>
                                    <th className="border-b border-slate-100 px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-600">Name</th>
                                    ...
                                    filteredCredits.map((item) => (
                                        <tr key={item.id} className="group transition-colors hover:bg-slate-50/50">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`rounded-full px-2.5 py-1 text-xs font-semibold ${item?.trancation_type === "Credit"
