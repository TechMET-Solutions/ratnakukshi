...
//       nextRelationValue.photoPreview = isFileLike(nextRelationValue.photo)
//         ? nextRelationValue.photoPreview || ""
//         : resolvePhotoUrl(nextRelationValue.photo);
...
const normalizeAssistanceDataForPayload = (value) => {
  ...
  return Object.entries(parsedValue).reduce((acc, [relation, relationValue]) => {
    const parsedRelationValue = parseMaybeJson(relationValue);
    acc[relation] =
      parsedRelationValue &&
      typeof parsedRelationValue === "object" &&
      !Array.isArray(parsedRelationValue)
        ? parsedRelationValue
        : {};
    return acc;
  }, {});
