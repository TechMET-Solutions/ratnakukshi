          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                onChange={(e) =>
                  handleEducationChange(rel, "minorityNumber", e.target.value)
                }
                className="border p-2 rounded outline-none focus:border-blue-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
            ...
            <div className="col-span-full">
              ...
              <div className="flex flex-wrap gap-6 mt-2">
                {["Dharamshala", "Vihardham", "Tapovan", "Bhojan Shala"].map(
                  (place) => (
                    <label
                      key={place}
                      className="flex items-center gap-2 text-sm text-gray-600"
                ...
                {["Yes", "No"].map((opt) => (
                  ...
                  >
                    <input
                      ...
                      name={`dietary-${rel}`}
                      checked={
                        assistanceData[rel]?.Food?.specialDietary === opt
                      }
                      onChange={() =>
                        handleFoodChange(rel, "specialDietary", opt)
                      }
                    />{" "}
                    {opt}
                  </label>
